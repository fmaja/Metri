...
class DayView(ctk.CTkFrame):
    ...
    def __init__(self, master, back_to_menu_callback=None, back_to_calendar_callback=None, selected_date=None, **kwargs):
    ...
    def _create_widgets(self):
        ...
        # Stopwatch display
        self._create_stopwatch(scrollable_frame)
        
        # Stats panel
        self._create_stats(scrollable_frame)
    ...
    def _create_stopwatch(self, parent):
        ...
        time_container.grid(row=1, column=0, pady=(10, 20), padx=40, sticky="ew")
        ...
        controls_frame.grid(row=2, column=0, pady=(0, 25))
    ...
    def _create_stats(self, parent):
        ...
        progress_section.grid(row=2, column=0, columnspan=2, padx=20, pady=(0, 25), sticky="ew")
